...
Local **`pnpm lint`** + **`typecheck`** OK this session; **`pnpm build`** / full **`pnpm test`** require **Node 24** (sandbox had Node **20**). **`main`** pushed (**`b735348`**). Prior **Deploy** success: run **25405261583** (2026-05-06).
