...
- **`tests/content/navLinks.test.ts`** (landed **P2-B2**, extended **P2-B3**, **P2-B4**, **P2-B5**) — proves every href
  ...
  `.../hipaa`, `.../hitrust`, `.../iso-27001-27002`; **`/about-us`** (**P2-B5**). Extend this pattern
